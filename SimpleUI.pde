...
public class SimpleUI {
  ...
  public void drawCanvas() {
    ...
    stroke(0, 0, 0); 
    strokeWeight(2);
    rect(canvasRect.left-1, canvasRect.top-1, canvasRect.getWidth()+1, canvasRect.getHeight()+1);
    popStyle();
  }
  public void drawOutlineMenu(){
    outlineRect = new SimpleUIRect(200, 20, 1050, 80);
    pushStyle();
    fill(100, 100, 100);
    stroke(0, 0, 0); 
    strokeWeight(2);
    rect(outlineRect.left, outlineRect.top, outlineRect.getWidth(), outlineRect.getHeight());
    popStyle();
  }
  public void drawOutlineShapes(){
    outlineRect = new SimpleUIRect(8, 118, 190, 270);
    pushStyle();
    fill(100, 100, 100);
    stroke(0, 0, 0); 
    strokeWeight(2);
  ...
  public void drawOutlineColours(){
    outlineRect = new SimpleUIRect(8, 290, 190, 620);
    pushStyle();
    fill(100, 100, 100);
    stroke(0, 0, 0); 
    strokeWeight(2);
  ...
  public void drawStrokeColour(float r,float g,float b){
    outlineRect = new SimpleUIRect(140, 340, 180, 400);
    pushStyle();
    fill(r, g, b);
    stroke(255, 255, 255); 
    strokeWeight(2);
  ...
  public void drawFillColour(float r,float g,float b){
    outlineRect = new SimpleUIRect(140, 440, 180, 500);
    pushStyle();
    fill(r, g, b);
    stroke(255, 255, 255); 
    strokeWeight(2);
  ...
  public void drawOutlineFilters(){
    outlineRect = new SimpleUIRect(1060, 118, 1270, 600);
    pushStyle();
    fill(100, 100, 100);
    stroke(0, 0, 0); 
    strokeWeight(2);
  ...
  public void drawOutlineFSliders(){
    outlineRect = new SimpleUIRect(1080, 400, 1250, 570);
    pushStyle();
    fill(140, 140, 140);
    stroke(0, 0, 0); 
    strokeWeight(2);
...
class SimpleButton extends Widget {
  ...
  public SimpleButton(String uiname, int x, int y, String uilable) {
    super(uiname, uilable, x, y, 70, 20);
